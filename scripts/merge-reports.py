...
TOOL_PARSERS = {
    ...
    "header-classifier": "parse_python_scanner",
    "header-poc-generator": "parse_python_scanner",
    "source-map-scanner": "parse_python_scanner",
    "timing-oracle": "parse_python_scanner",
