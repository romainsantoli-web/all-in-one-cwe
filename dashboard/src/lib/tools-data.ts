...
export const PARALLEL_GROUPS: ParallelGroup[] = [
  ...
  { name: "waf-evasion", tools: ["waf-bypass", "header-classifier"], dependsOn: ["recon"] },
...
export const LLM_PROVIDERS = [
  ...
  { name: "copilot-pro", model: "claude-sonnet-4.6", envVar: "COPILOT_JWT" },
  { name: "copilot", model: "gpt-4o", envVar: "GITHUB_TOKEN" },
